...
- To classify the test instances, we use the ~knn~ function from the
  ...
  The downloaded source packages are in
          ‘/tmp/Rtmp9zFrzd/downloaded_packages’
...
- This works because the ~TRUE~ and ~FALSE~ values of the ~logical~ argument
  ...
  :  [17]  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE FALSE
  :  [33]  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE
  :  [49]  TRUE  TRUE  TRUE  TRUE  TRUE FALSE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE
