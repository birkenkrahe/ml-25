...
* TODO Intermission: Saving and loading an R session image
...
- Taking stock! The ~ls()~ function has a pattern argument. Use it to
  ...
  #+RESULTS:
  :  [1] "sms_corpus"         "sms_corpus_clean"   "sms_dtm"            "sms_dtm_freq_test" 
  :  [5] "sms_dtm_freq_train" "sms_dtm_test"       "sms_dtm_train"      "sms_dtm2"          
  :  [9] "sms_freq_words"     "sms_raw"            "sms_test"           "sms_test_labels"   
...
- We use the algorithm implemented in the imaginatively named ~e1071~
  ...
  trying URL 'https://mirrors.nics.utk.edu/cran/src/contrib/proxy_0.4-27.tar.gz'
  Content type 'application/x-gzip' length 74622 bytes (72 KB)
  ==================================================
  downloaded 72 KB

  trying URL 'https://mirrors.nics.utk.edu/cran/src/contrib/e1071_1.7-16.tar.gz'
  ...
  gcc -I"/usr/share/R/include" -DNDEBUG      -fpic  -g -O2 -ffile-prefix-map=/build/r-base-4A2Reg/r-base-4.1.2=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c arrayIndex.c -o arrayIndex.o
  gcc -I"/usr/share/R/include" -DNDEBUG      -fpic  -g -O2 -ffile-prefix-map=/build/r-base-4A2Reg/r-base-4.1.2=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c distance.c -o distance.o
  ...
  installing to /home/aletheia/R/x86_64-pc-linux-gnu-library/4.1/00LOCK-proxy/00new/proxy/libs
  ,** R
  ,** inst
  ,** byte-compile and prepare package for lazy loading
  ,*** Loaded .Rprofile ***
  ...
  g++ -std=gnu++14 -I"/usr/share/R/include" -DNDEBUG      -fpic  -g -O2 -ffile-prefix-map=/build/r-base-4A2Reg/r-base-4.1.2=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c svm.cpp -o svm.o
  ...
  installing to /home/aletheia/R/x86_64-pc-linux-gnu-library/4.1/00LOCK-e1071/00new/e1071/libs
  ,** R
  ,** inst
  ,** byte-compile and prepare package for lazy loading
  ,*** Loaded .Rprofile ***
  ...
  The downloaded source packages are in
          ‘/tmp/RtmpwZ6Eih/downloaded_packages’
  [1] ".GlobalEnv"           "package:e1071"        "package:tm"           "package:NLP"         
   [5] "package:wordcloud"    "package:RColorBrewer" "ESSR"                 "package:stats"       
