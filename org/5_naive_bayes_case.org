#+TITLE: Supervised Learning with Naive Bayes - Case study
...
- Install and load ~tm~ (load it from the terminal if you haven't set
  ...
  trying URL 'https://mirrors.nics.utk.edu/cran/src/contrib/NLP_0.3-2.tar.gz'
  Content type 'application/x-gzip' length 148824 bytes (145 KB)
  ==================================================
  downloaded 145 KB

  trying URL 'https://mirrors.nics.utk.edu/cran/src/contrib/slam_0.1-55.tar.gz'
  Content type 'application/x-gzip' length 55018 bytes (53 KB)
  ==================================================
  downloaded 53 KB

  trying URL 'https://mirrors.nics.utk.edu/cran/src/contrib/BH_1.87.0-1.tar.gz'
  ...
  ,** using staged installation
  ,** libs
  gcc -I"/usr/share/R/include" -DNDEBUG      -fpic  -g -O2 -ffile-prefix-map=/build/r-base-4A2Reg/r-base-4.1.2=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c apply.c -o apply.o
  gcc -I"/usr/share/R/include" -DNDEBUG      -fpic  -g -O2 -ffile-prefix-map=/build/r-base-4A2Reg/r-base-4.1.2=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c dll.c -o dll.o
  gcc -I"/usr/share/R/include" -DNDEBUG      -fpic  -g -O2 -ffile-prefix-map=/build/r-base-4A2Reg/r-base-4.1.2=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c grouped.c -o grouped.o
  gcc -I"/usr/share/R/include" -DNDEBUG      -fpic  -g -O2 -ffile-prefix-map=/build/r-base-4A2Reg/r-base-4.1.2=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c sparse.c -o sparse.o
  gcc -I"/usr/share/R/include" -DNDEBUG      -fpic  -g -O2 -ffile-prefix-map=/build/r-base-4A2Reg/r-base-4.1.2=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c util.c -o util.o
  ...
  installing to /home/aletheia/R/x86_64-pc-linux-gnu-library/4.1/00LOCK-slam/00new/slam/libs
  ,** R
  ,** inst
  ,** byte-compile and prepare package for lazy loading
  ,*** Loaded .Rprofile ***
  ...
  The downloaded source packages are in
          ‘/tmp/Rtmp5hDUTt/downloaded_packages’
...
- Check that the package has been loaded and look at the methods
  ...
  [11] "Autoloads"         "package:base"
   [1] "as.DocumentTermMatrix"   "as.TermDocumentMatrix"   "as.VCorpus"              "Boost_tokenizer"        
   [5] "content_transformer"     "Corpus"                  "DataframeSource"         "DirSource"              
   [9] "Docs"                    "DocumentTermMatrix"      "DublinCore"              "DublinCore<-"           
  [13] "eoi"                     "findAssocs"              "findFreqTerms"           "findMostFreqTerms"      
  [17] "FunctionGenerator"       "getElem"                 "getMeta"                 "getReaders"             
  [21] "getSources"              "getTokenizers"           "getTransformations"      "Heaps_plot"             
  [25] "inspect"                 "MC_tokenizer"            "nDocs"                   "nTerms"                 
  [29] "PCorpus"                 "pGetElem"                "PlainTextDocument"       "read_dtm_Blei_et_al"    
  [33] "read_dtm_MC"             "readDataframe"           "readDOC"                 "reader"                 
  [37] "readPDF"                 "readPlain"               "readRCV1"                "readRCV1asPlain"        
  [41] "readReut21578XML"        "readReut21578XMLasPlain" "readTagged"              "readXML"                
  [45] "removeNumbers"           "removePunctuation"       "removeSparseTerms"       "removeWords"            
  [49] "scan_tokenizer"          "SimpleCorpus"            "SimpleSource"            "stemCompletion"         
  [53] "stemDocument"            "stepNext"                "stopwords"               "stripWhitespace"        
  [57] "TermDocumentMatrix"      "termFreq"                "Terms"                   "tm_filter"              
  [61] "tm_index"                "tm_map"                  "tm_parLapply"            "tm_parLapply_engine"    
  [65] "tm_reduce"               "tm_term_score"           "URISource"               "VCorpus"                
  [69] "VectorSource"            "weightBin"               "WeightFunction"          "weightSMART"            
  [73] "weightTf"                "weightTfIdf"             "writeCorpus"             "XMLSource"              
  [77] "XMLTextDocument"         "Zipf_plot"               "ZipSource"
  Data sets in package ‘tm’:

  acq                               50 Exemplary News Articles from the Reuters-21578 Data Set of Topic
                                    acq
  crude                             20 Exemplary News Articles from the Reuters-21578 Data Set of Topic
                                    crude
  #+end_example
