...
- To run the code below, open [[https://tinyurl.com/2mnv425w][tinyurl.com/2mnv425w]], save the file to
  ~nile.org~ and open it in Emacs.
...
- You can look at the text file using ~notepad~ (Windows) or =cat=
  (Linux):
  #+begin_src R :results silent
