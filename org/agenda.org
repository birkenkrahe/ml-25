...
- [ ] *Test 2:* Counted late submissions bc of network isues
- [ ] *Test 3* due tonight (max 100%)
- [ ] *R Basics review:* vectors, factors, lists, data frames
- [ ] *Lecture*: Machine Learning Models

** TODO R Review: Data structures / Managing / Exploring
...
- Upload your result then follow the review.
