...
- [ ] *Course evaluation:* Take 10 minutes to evaluate this course!
- [ ] *DataCamp*: Unsupervised learning course due Friday May 9th.
- [ ] *Test 7*: Due Tuesday, 6th May (linear regression).
- [ ] *Test 8:* Due Friday, 9th May (unsupervised learning).
- [ ] *Grading*: Will drop the worst/missing test/home assignment.
- [ ] *Final presentation*: Book your slot & complete the checklist.
- [ ] *Wait!* What about unsupervised learning?
- [ ] *Code along*: Regression case study (insurance data).

** TODO Wait! What about unsupervised learning?
...
p  prediction, medical diagnosis, etc.) are supervised problems.
...
** TODO Regression case study - code along
