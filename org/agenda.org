...
* Week 6: R Review: Exploring data & Machine Learning Models

- [ ] *Test 4* live until Friday, 28 Feb (Mar 4) for 100% (50%)
- [ ] *R Basics:* Explore data (finish)
- [ ] *Lecture*: Machine Learning Models
- [ ] *Project* feedback in class - what are your takeaways?
...
6. Which plot type (almost) represents the ~summary~? And what's in the
   ~summary~ that's not in this plot?
   #+attr_html: :width 400px: 
   [[../img/spread.png]]
