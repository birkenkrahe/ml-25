...
* Week 9: kNN Case Study & Naive Bayes 
...
- [ ] *New bonus kNN exercises*: I posted two new (bonus) exercises for
...
- [ ] *Curse of dimensionality*: New PDF posted in chat - read before
...
- [ ] *kNN case study*: code along! This time, your brain won't hurt
