...
- [ ] *Project review* with Minto's SCQA method.

** DONE Using GAI when doing research (help me help you)
#+attr_html: :width 600px :float nil:
...
** TODO Project review (3rd sprint - abstract)
