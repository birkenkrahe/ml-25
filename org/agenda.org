...
- [ ] *Test 2* is live - deadline Tuesday 4-Feb (100%).
...
** DONE DataCamp review questions and answers (test 2)
...
** TODO Model training, generalization, and evaluation

- *Review:* What did you learn in the last couple of sessions?
...
- Surprised/amazed/shocked:
  #+begin_quote
  1. So many project ideas (check the Google Chat).
